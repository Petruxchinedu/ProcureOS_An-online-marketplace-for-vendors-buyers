...
const verifyEmail = (token)=>api.get(`/auth/verify-email?token=${token}`);
const forgotPassword = (email)=>api.post("/auth/forgot-password", {
        email
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__27430645._.js.map